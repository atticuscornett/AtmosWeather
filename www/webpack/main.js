...
var root_1 = svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.add_locations(svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.template(`<h1> </h1>`), LocationWeatherPage[svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.FILENAME], [[12, 4]]);
...
var root_4 = svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.add_locations(svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.template(`<div class="location svelte-1a93ir3"><h2>You have no locations.</h2></div>`), LocationsPage[svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.FILENAME], [[76, 12, [[76, 34]]]]);
		...
		for (let i = 0; i < svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.get(nomLocations).length; (i += 1) - 1) {
			nomToWeatherGridAsync(svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.get(nomLocations)[i], (nomRes) => {
				getHourlyForecastAsync(nomRes, (hourly) => {
					getStatusAsync(svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.get(nomLocations)[i], (fullStatus) => {
		...
		(0,_Layout_TabSlot_svelte__WEBPACK_IMPORTED_MODULE_2__["default"])($$anchor, {
			...
			children: svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.wrap_snippet(LocationsPage, ($$anchor, $$slotProps) => {
				...
				button.__click = function (...$$args) {
					svelte_internal_client__WEBPACK_IMPORTED_MODULE_1__.apply(() => page("search"), this, $$args, LocationsPage, [82, 39], true);
				};
